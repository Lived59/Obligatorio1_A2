#include <iostream>
#include <string>
#include "./tads/hash_cerrado.cpp"
#include "./tads/hash_cerrado_dominio.cpp"

using namespace std;

static void borrarPaths(const string& recursos, const string& dominio, HashCerrado& asociacion, HashDominio& dominios) {
    string path;
...
int main() {
    ...
    HashCerrado asociacion((unsigned int)N);
    HashDominio dominios((unsigned int)N);
